...
\section{Equilibrium I}
	...
	\begin{center} \ch{N2 + 3H2 <=> 2NH3} \(\quad \Delta H^\plimsoll = \SI{92}{\kJ\per\mol}\) \end{center}
	...
	\begin{center} \ch{2SO2 + O2 <=> 2SO3} \(\quad \Delta H^\plimsoll = \SI{-197}{\kJ\per\mol}\) \end{center}
