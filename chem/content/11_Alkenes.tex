...
\section{Alkenes}
	...
	\noindent \textbf{Addition of Hydrogenhalide}
	...
	Terminal / primary \ch{C} are reacted into \ch{CO2 + H2O}, secondary \ch{C} are converted into terminal \ch{COOH} groups and tertiary \ch{C} are converted into ketone groups. \\
	...
	Note that \ch{CO2} is not an organic product as it does not contain \ch{C-H} bonds.
