...
\section{Stoichiometry}
	...
	\scidef{Nuclide}{A Nuclide is a species of atom with a specific proton number and nucleon number, written \ch{^{Proton Number}_{Nucleon Number}X}}
	...
	\scidef{Molar Volume}{The Molar Volume \usub{V}{m} is the volume taken up by 1 mole of gas at a certain temperature and pressure. Common temperatures and pressures include: \\
		...
		Room Temperature and Pressure (r.t.p.) at \SI{293}{\K} and \SI{101325}{\Pa} or \SI{1}{\bar} gives \usub{V}{m} = \SI{24}{\dm\cubed\per\mol}.
	}
