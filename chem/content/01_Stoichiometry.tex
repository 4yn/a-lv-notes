...
\section{Stoichiometry}
	...
	Manganate(VII) titrations involve the half-reaction \ch{MnO4- + 8 H+ + 5 e- -> Mn^{2+} + 4 H2O} in acidic medium and \ch{MnO4- + 4 H+ + 3 e- -> MnO2 + 2 H2O} in basic medium. Due to the purple color of \ch{MnO4-}, the reaction is self-indicating and the end point is reached whenever there is an appearance or disappearance of purple tint in the solution.\\

	\ch{Fe^{3+}} solutions in \ch{MnO4-} titrations are yellow before titration, while \ch{H2O2} solutions are colorless. \\

	Dichromate(VI) titrations involve the half-reaction \ch{Cr2O7^{2-} + 14 H+ + 6 e- -> 2 Cr^{3+} + 7 H2O} in acidic medium. Though orange \ch{Cr2O7^{2-}} ions turn into green \ch{Cr^{3+}} ions, green appears significantly before an endpoint is reached and hence requires indicators like barium / sodium dipheylamine p-sulphonate or diphenylamine (green to blue-violet) or N-phenylanthranilic acid (green to red-violet). \\
