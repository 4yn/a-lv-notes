...
\section{Intro to Organic}
	...
	A molecule generally needs to contain \ch{C-H} bonds to be called an organic species. Molecules such as \ch{CO2} are not organic species.

	\subsection{Carbon in Organic Chemistry}

	Carbon \ch{^{6}C} is able to form many compounds because of its properties when having 4 electrons in its valence shell.
	...
	\chfg{
		\subscheme[-90]{
		    \subscheme{
				\chemfig{R-[:30](=[2]O)-[:-30]OH}	\arrow{0}[,0.2]
				\chemfig{R-[:30](=[2]O)-[:-30]O-[:30]R}	\arrow{0}[,0.2]
				\chemfig{R-[:30](=[2]O)-[:-30]X}	\arrow{0}[,0.2]
				\chemfig{R-[:30](=[2]O)-[:-30]NH_2}	
			}
			\arrow{0}[,0.2]
		    \subscheme{
				\chemfig{R~N}	\arrow{0}[,0.2]
				\chemfig{R-[:30](=[2]O)-[:-30]H}	\arrow{0}[,0.2]
				\chemfig{R-[:30](=[2]O)-[:-30]R}	\arrow{0}[,0.2]
				\chemfig{R-[:30]-[:-30]OH}	\arrow{0}[,0.2]
				\chemfig{R-NH_2}
			}
			\arrow{0}[,0.2]
		    \subscheme{
				\chemfig{R-[:30](-[2]NH_2)-[:-30](=[6]O)-[:30]OH}	\arrow{0}[,0.2]
				\chemfig{[:30]**6(--(-X)----)}	\arrow{0}[,0.2]
				\chemfig{[:30]**6(--(-OH)----)}
			}
		}
	}
	...
	\scidef{Nucleophile}{A Nucleophile is a species of particle which has a lone pair of electrons, is electron-rich and/or readily donates electrons.}
	...
	\scidef{Step Up/Step Down}{Step Up and Step Down reactions involve the formation of and removal of \ch{C-C} bonds respectively.}
