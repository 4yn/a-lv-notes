...
\section{Hydroxy Compounds}
	...
	\chfg{
		\chemfig{R-C(-[:270]H)(-[:90]CH3)-OH} \+ \ch{Na} \arrow \chemfig{R-C(-[:90]CH3)=O} \+ \ch{HI}
	} \\
	\chfg{
		\chemfig{R-C(-[:90]CH3)=O} \+ \ch{3I2} \arrow \chemfig{R-C(-[:90]CI3)=O} \+ \ch{3HI}
	} \\
	\chfg{
		\chemfig{R-C(-[:90]CI3)=O} \+ \ch{OH-} \arrow \chemfig{R-C(-[:90]\ch{O-})=O} \+ \ch{CHI3}
	} \\
