...
\section{Electromagnetism}
	...
	\scidef{Magnetic Flux Density}{The Magnetic Flux Density of a magnetic field quantities force per unit length of a long straight conductor carrying current at right angles to the magnetic field, measured in Tesla \si{\tesla} or \si{\N\per\ampere\per\meter}.}
	...
	\scieqn{Electric and Magnetic Force on Free Charge}{The total force \(F\) experienced by a charge \(q\) in an electric field \(E\) and magnetic field \(B\) while moving in velocity \(v\) is given by the equation}{ F = q ( \overrightarrow{E} + \overrightarrow{B} \times \overrightarrow{v} )}
