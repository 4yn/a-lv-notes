...
\section{Circular Motion}
	...
	\scidef{Angular Velocity}{Angular Velocity \(\omega\) is defined as the rate of change of angular displacement with respect to time, measured in \si{rad s^{-1}}}

	\scidef{Period}{A period of a system \(P\) is the time taken for a system to complete one cycle of motion, measured in \si{Hz} or \si{s^{-1}}}
