...
\section{Gravitation}
	...
	\scidef{Gravitational Field Strength}{The Gravitational Field Strength \(g\)at a point is the gravitational force experienced per unit mass at a point, with units \si{m s^{-2}}.}
	...
	\scidef{Gravitational Potential}{Gravitational Potential \(\phi\) at a point is the work done per unit mass by a external force in bringing a test mass from infinity to a point, with units \si{J kg^{-1}}.}
	...
	The escape velocity of a body is the velocity required such that said body is able to travel to infinity away from a planetary mass. Escape velocity is independent of the mass of the escaping object. Escape from Earth requires a speed of about \si{11.2 \times 10^3 m s^{-1}}.
