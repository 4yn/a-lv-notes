...
\section{Superposition}
	...
	\scieqn{Rayleigh Condition}{For a image to just be resolved when observed through an aperture, angular separation (crossing both sides of the medial line) \(\theta\), wavelength \(\lambda\) and size of aperture \(b\)}{\theta \approx \frac{\lambda}{b}}
