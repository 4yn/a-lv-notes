...
\section{Electric Field}
	...
	\scidef{Coulomb \si{\coulomb}}{The Coulomb \si{\coulomb} is the SI unit for electric charge. One coulomb is the amount of charge passing through one point with current \SI{1}{\ampere}.}

	\scidef{Electric Charge}{An electric charge is a collection of particles which exert a force in an electric field.}
