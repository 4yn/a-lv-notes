...
\section{Dynamics}
	...
	\scidef{Momentum is defined as the product of the mass of an object and its velocity with units \si{N m} or \si{kg m^2 s^{-2}}.}
	...
	\scieqn{Conservation of Momentum}{ m_1u_1 + m_2u_2 = m_1v_1 m_2v_2 }
	...
	\scieqn{Conservation of Kinetic Energy}{ m_1u_1^2 + m_2u_2^2 = m_1v_1^2 m_2v_2^2 }
	...
	\scieqn{Elastic Collision: Constant Relative Speed}{ u_1 - u_2 = v_2 - v_1 }
