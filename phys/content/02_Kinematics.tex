...
\section{Kinematics}
	...
	\scidef{Acceleration}{Acceleration a is the instantaneous velocity of an object, defined as the rate of change of velocity with respect to time, measured in \si{m.s^{-2}}. Average acceleration refers to the change in velocity over a significantly large time taken.}
